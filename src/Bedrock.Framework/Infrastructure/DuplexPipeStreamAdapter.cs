...
namespace Bedrock.Framework.Infrastructure
{
    ...
    internal class DuplexPipeStreamAdapter<TStream> : DuplexPipeStream, IDuplexPipe where TStream : Stream
    {
        ...
        public DuplexPipeStreamAdapter(IDuplexPipe duplexPipe, Func<Stream, TStream> createStream) :
            this(duplexPipe, new StreamPipeReaderOptions(leaveOpen: true, bufferSize:1024,minimumReadSize:1024), new StreamPipeWriterOptions(leaveOpen: true, minimumBufferSize: 1024), createStream)
        {
        }
